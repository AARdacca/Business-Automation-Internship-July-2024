...
<body>
                                ...
                                @if (Route::has('login'))
                                    @auth
                                        <li class="nav-item mr-5">
                                            <a href="{{ url('/dashboard') }}" class="nav-link"> <span>Dashboard</span>
                                            </a>
                                        </li>
                                    @else
                                        <li class="nav-item mr-5">
                                            <a href="{{ route('login') }}" class="nav-link"> <span>Log in</span>
                                            </a>
                                        </li>
                                        @if (Route::has('register'))
                                            <li class="nav-item mr-5">
                                                <a href="{{ route('register') }}" class="nav-link"> <span>Register</span>
                                                </a>
                                            </li>
                                        @endif
                                    @endauth
                            ...
                            <div class="slider_item-box">
                                <div class="slider_item-container">
                                    ...
                                    <div class="slider_item-imgbox">
                                        <img src="template/images/pc-banner.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="about_card-container layout_padding2-top">
                    ...
                    <div class="about-detail">
                        <div class="about_img-container">
                            <div class="about_img-box">
                                <img src="template/images/work1.png" alt="" />
                            </div>
                        </div>
                ...
                <div class="about_card">
                    <div class="about-detail">
                        <div class="about_img-container">
                            <div class="about_img-box">
                                <img src="template/images/work2.png" alt="" />
                            </div>
                        </div>
                        <div class="card_detail-ox">
                            <h4>
                ...
                <div class="about_card">
                    <div class="about-detail">
                        <div class="about_img-container">
                            <div class="about_img-box">
                                <img src="template/images/work3.png" alt="" />
                            </div>
                        </div>
                        <div class="card_detail-ox">
                            <h4>
    ...
    <!-- who section -->
    <section class="who_section" id="who_are_we">
        <div class="container who_container">
            <div class="who_img-box">
                <img src="template/images/pc.jpg" alt="" />
            </div>
                ...
                <div class="col-md-6">
                    <div class="col-md-10 offset-md-2">
                        <div class="contact_img-box">
                            <img src="template/images/form-img.jpg" alt="" />
                        </div>
                    </div>
                </div>
        ...
        <div class="container info_content">
            ...
            <div
                ...
                <div class="social-box">
                    <a href="">
                        <img src="template/images/fb.png" alt="" />
                    </a>

                    <a href="">
                        <img src="template/images/twitter.png" alt="" />
                    </a>
                    <a href="">
                        <img src="template/images/linkedin1.png" alt="" />
                    </a>
                    <a href="">
                        <img src="template/images/instagram1.png" alt="" />
                    </a>
                </div>
    ...
    <section class="container-fluid footer_section">
        <p>
            &copy; 2024 All Rights Reserved. Integrated and Customized by <a href="https://www.linkedin.com/in/aliahasanraiyan">Ali Ahasan</a>. Design by
