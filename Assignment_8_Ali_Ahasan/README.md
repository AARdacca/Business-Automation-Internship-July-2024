# Newsoft Laravel App Project Setup Guide
...
Follow these steps to download and set up the `Newsoft` on your local server environment.
...
1. Go to the GitHub repository URL where the `Newsoft` is hosted.
...
6. Paste the `Newsoft` directory inside `htdocs`.

### Step 4: Confirm that `Newsoft` directory is directly under htdocs.

# Newsoft Laravel App Project Setup Instructions
